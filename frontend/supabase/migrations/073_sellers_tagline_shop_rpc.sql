-- Short storefront blurb (card under stats, above tabs). Distinct from business_info (full About).

alter table public.sellers
  add column if not exists tagline text;

comment on column public.sellers.tagline is
  'Short public summary under seller stats — e.g. one or two sentences. Full story stays in business_info.';
...
comment on function public.get_active_shop_listings() is
  ...
  'Includes seller_username, seller_tagline, seller_business_info from sellers; '
