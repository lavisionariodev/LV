-- Expose sellers.social_links on public shop RPC (buyer-facing).
-- Keep sellers/profiles RLS closed; only expose via SECURITY DEFINER curated payload.
...
comment on function public.get_active_shop_listings() is
  'SECURITY DEFINER: public shop listings; includes curated seller storefront fields + seller_social_links.';
