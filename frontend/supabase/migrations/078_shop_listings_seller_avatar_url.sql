-- Expose seller's profile avatar (business logo) on shop listings RPC for storefront UIs.
...
comment on function public.get_active_shop_listings() is
  'SECURITY DEFINER: public shop listings; includes profiles.avatar_url as seller_avatar_url.';
