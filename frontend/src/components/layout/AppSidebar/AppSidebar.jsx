  ...
  seller: {
    ...
    navItems: [
      ...
      { href: '/seller/wallet', label: 'Wallet', icon: TbWallet },
      {
        label: 'Listings',
        icon: TbPackage,
        defaultHref: '/seller/listings/catalog',
        children: [
          { href: '/seller/listings/services', label: 'Services' },
          { href: '/seller/listings/packages', label: 'Packages' },
          { href: '/seller/listings/products', label: 'Products' },
          { href: '/seller/listings/catalog', label: 'Catalog' },
          { href: '/seller/listings/new-listing', label: 'Add New Listing' },
        ],
      },
